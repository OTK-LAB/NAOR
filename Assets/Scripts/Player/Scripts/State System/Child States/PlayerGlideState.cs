...
{
    public class PlayerGlideState : MainState, IMove2D
    {
        ...
        public PlayerGlideState(PlayerMain player, PlayerStateMachine stateMachine, PlayerMain.AnimName animEnum, PlayerData playerData) : base(player, stateMachine, animEnum, playerData)
        {
        }
        ...
        public void Move2D()
        {
            ...
            _newVelocity.y = Mathf.Clamp(_newVelocity.y, playerData.Land.MinLandSpeed, float.MaxValue) * playerData.Glide.FallSpeedMultiplier;
